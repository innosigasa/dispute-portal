...
public class AgentDisputeService : IAgentDisputeService
{
    private readonly IDisputeRepository disputeRepo;
    private readonly INotificationService notificationService;
    private readonly ICurrentUserService currentUser;
    private readonly IValidator<UpdateDisputeStatusCommand> statusValidator;

    public AgentDisputeService(IDisputeRepository disputeRepo,
        INotificationService notificationService,
        ICurrentUserService currentUser,
        IValidator<UpdateDisputeStatusCommand> statusValidator)
    {
